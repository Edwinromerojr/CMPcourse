...
android {
    namespace = "org.kot.cmpcourse"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.kot.cmpcourse"
...
compose.desktop {
    application {
        mainClass = "org.kot.cmpcourse.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "org.kot.cmpcourse"
...
sqldelight {
    databases {
        create("TodoDatabase") {
            packageName.set("org.kot.cmpcourse")
        }
    }
}
